...
class ApiProductos 
{
    ...
    public function obtenerTodos()
    {
        ...
        if (isset($_GET['id'])) {
            $id = $_GET['id'];
            $stmt = $this->pdo->prepare("SELECT p.*, e.nombre_empresa FROM producto p JOIN empresa e ON p.id_empresa_producto = e.id_empresa WHERE p.id_producto = ?");
            $stmt->execute([$id]);
            ...
            $stmt = $this->pdo->prepare("SELECT p.*, e.nombre_empresa FROM producto p JOIN empresa e ON p.id_empresa_producto = e.id_empresa");
            $stmt->execute();
